...
namespace Controllers
{
    ...
    public class SalutiController : Controller
    {
        ...
        {
            return Ok(new InfoMsg("101", $"Saluti {Nome}, sono la tua web api csharp in GitHub Azure App Services"));
        }
        ...
        {
            return Ok(new InfoMsg("101", $"Saluti {Nome}, sono la versione {version}  GitHub della web api"));
        }
